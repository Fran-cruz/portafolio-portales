export const about = {
  fullName: "Francisco Joel Cruz Fernández",
  role: "Estudiante de Ingeniería en Ciencias de la Computación · Desarrollador Full Stack · Entusiasta de la Robótica",
  photo:
  ...
  codeSnippet: [
    ...
    '  otros: ["Python", "Arduino", "ESP32", "PLC"],',
    '  mentalidad: "Aprende rápido. Construye más rápido."',
    '};',
  ],
  footerNote:
    "Este mismo portafolio fue construido con React, Vite y React Router como parte del proyecto de la clase de Portales Web I.",
};
